            ...
            ngDialog.open({
                ...
                controller: ['$scope', '$interval', function ($scope, $interval) {
                    ...
                    $scope.selectbeauticianIndex = function(index,beauticianName,beauticianId){
                        ...
                        $scope.param.ModifyAppointmentObject.beauticianId =beauticianId;
                        /*setTimeout(function(){
