 function modifyingAppointmentPage ($scope){
     $scope.param.dayTime=[];
...
console.log($scope.param.selectedTime)
         };
     selectCustomersCtrl && selectCustomersCtrl($scope);
     selectProductCtrl && selectProductCtrl($scope);
     selectTimeLengthCtrl && selectTimeLengthCtrl($scope);
 }
