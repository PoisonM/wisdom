...
public class UserConsumeController {
	...
	public @ResponseBody ResponseDTO<String> consumesDaughterCard(
			@RequestBody ShopConsumeDTO<List<ShopUserConsumeDTO>> shopUserConsumeDTO) {
	...
	public @ResponseBody ResponseDTO<String> consumesUserProduct(
			@RequestBody ShopConsumeDTO<List<ShopUserConsumeDTO>> shopUserConsumeDTO) {
	 ...
	 * @Param:
	 * @Return:
	 * @Description: 根据疗程卡Id获取疗程和套卡的划卡记录 套卡查询需要传递flowIds goodsType 疗程卡查询需要传递flowId
	 *               goodsType
	 * @Date:2018/4/10 11:20
	 */
