...
public class SignUtil {
     ...
     * @return
     */
    public static boolean checkCustomerSignature(String signature, String timestamp, String nonce) {
        String[] arr = new String[] { customerToken, timestamp, nonce };
    ...
    private static String dictSort(String[] arr)
    {
